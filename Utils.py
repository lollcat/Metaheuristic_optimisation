...
def multiple_runs_with_different_seed(Class, class_argument, n_iterations, method="SA"):
    results = []
    for i in range(n_iterations):
        ...
        if method == "SA":
            ...
            results.append(
                [objective_result, instantiated_class.parent_objective_history_array.min(), time.time() - start_time])
